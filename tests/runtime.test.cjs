...
function boot(saved){
 ...
 const context=new Proxy({createLinearGradient:()=>({addColorStop(){}})}, {get:(t,k)=>k in t?t[k]:()=>{},set:(t,k,v)=>(t[k]=v,true)});
 class Element{
 ...
 return {ids,registry,getState,part,slot,craftDone,tick,project,timers,context};
}
